...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-[#5D3891] shadow-md z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <img src="https://static.vecteezy.com/system/resources/thumbnails/004/297/596/small/education-logo-open-book-dictionary-textbook-or-notebook-with-sunrice-icon-modern-emblem-idea-concept-design-for-business-libraries-schools-universities-educational-courses-vector.jpg" alt="Books" className="h-8 w-8 mr-2" />
            <span className="font-bold text-xl text-[#F5F5F5]">Public Library</span>
          </div>
          <div className="flex items-center">
            {isLoggedIn && (
              <div className="flex items-center mr-4 relative">
                
                <FaBell className="text-[#FFD700] h-6 w-6" />
            ...
            <button
              ...
              className={`px-4 py-2 rounded text-white font-medium text-sm ${
                isLoggedIn ? 'bg-green-500 hover:bg-[#F99417]' : 'bg-red-500 hover:bg-[#F99417]'
              }`}
            >
              {isLoggedIn ? 'Signout' : 'Home'}
            </button>
          </div>
        </div>
      </div>
